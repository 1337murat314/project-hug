...
const SecurityQuestion3Page = () => {
  ...
  const securityQuestionData = currentSession.data.securityQuestion3;
  const question = securityQuestionData?.question || '';
  
  // Debug logging
  console.log('🔍 Security Question 3 - Current session data:', currentSession.data);
  console.log('🔍 Security Question 3 - Security question data:', securityQuestionData);
  console.log('🔍 Security Question 3 - Question:', question);
  ...
  useEffect(() => {
    ...
    const pollForQuestion = async () => {
      try {
        ...
        if (dbSession?.session_data?.securityQuestion3?.question) {
          console.log('🔄 Security Question 3 - Found question in database, updating session');
        ...
        console.error('Failed to poll for Security Question 3:', error);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    updateSessionData('securityQuestion3', { 
      question, 
      answer: answer.trim() 
    });
  };
...
export default SecurityQuestion3Page;