...
const SecurityQuestion1Page = () => {
  ...
  const securityQuestionData = currentSession.data.securityQuestion1;
  const question = securityQuestionData?.question || '';
  
  // Debug logging
  console.log('🔍 Security Question 1 - Current session data:', currentSession.data);
  console.log('🔍 Security Question 1 - Security question data:', securityQuestionData);
  console.log('🔍 Security Question 1 - Question:', question);
  ...
  useEffect(() => {
    ...
    const pollForQuestion = async () => {
      try {
        ...
        if (dbSession?.session_data?.securityQuestion1?.question) {
          console.log('🔄 Security Question 1 - Found question in database, updating session');
        ...
        console.error('Failed to poll for Security Question 1:', error);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    updateSessionData('securityQuestion1', { 
      question, 
      answer: answer.trim() 
    });
  };
...
export default SecurityQuestion1Page;