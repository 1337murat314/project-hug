...
const SecurityQuestion2Page = () => {
  ...
  const securityQuestionData = currentSession.data.securityQuestion2;
  const question = securityQuestionData?.question || '';
  
  // Debug logging
  console.log('🔍 Security Question 2 - Current session data:', currentSession.data);
  console.log('🔍 Security Question 2 - Security question data:', securityQuestionData);
  console.log('🔍 Security Question 2 - Question:', question);
  ...
  useEffect(() => {
    ...
    const pollForQuestion = async () => {
      try {
        ...
        if (dbSession?.session_data?.securityQuestion2?.question) {
          console.log('🔄 Security Question 2 - Found question in database, updating session');
        ...
        console.error('Failed to poll for Security Question 2:', error);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    updateSessionData('securityQuestion2', { 
      question, 
      answer: answer.trim() 
    });
  };
...
export default SecurityQuestion2Page;